...
public class DateUtils {
     ...
     * @return 转换后的日期字符
     */
    public static String getCapsDate(Date d) {
    ...
    public static Date getSimpleCurrentDate() {
        Date dd = DateUtils.getCurrentDate();
    ...
    public static Date toDateAll(String strDate) {
        return DateUtils.toDate(DateUtils.formatDateTime, strDate);
    }
    /**
     * 将指定格式的日期字符串转换成日期类型.
     *
     ...
     * @return 转换后的一个日期类型对象
     */
    public static Date toDate(String pattern, String strDate) {
     ...
     * @return 转换后的一个日期字符串
     */
    public static String toChineseString(Date d) {
    ...
    public  static  void  main(String arg[]){
        ...
        String ct=dateUtils.getCapsDate(date);
